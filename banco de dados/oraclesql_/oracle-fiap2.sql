...
INSERT INTO T_SIP_FUNCIONARIO 
     VALUES (12380, 4, 
             'LAURA DOS SANTOS',
             TO_DATE('10/03/1998','DD/MM/YYYY'), 
             TO_DATE('24/10/2018','DD/MM/YYYY'),
             'RUA Y, 55', 
             900);
      
 -- PREENCHIMENTO COM NULL DE FORMA EXPLICITA
INSERT INTO T_SIP_PROJETO 
     VALUES (10006,
             'PROJETO 6', 
...
-- ATUALIZANDO OS DADOS DOS FUNCIONÁRIOS APÓS DISSÍDIO
UPDATE T_SIP_FUNCIONARIO
...
-- ATUALIZANDO O PROJETO FINALIZADO E ENTREGUE AO CLIENTE
UPDATE T_SIP_PROJETO
   SET DT_TERMINO = TO_DATE('19/05/2021','DD/MM/YYYY')
 WHERE CD_PROJETO = 10001;      
      
      
      
-- DELETANDO IMPLANTAÇÃO
DELETE FROM T_SIP_IMPLANTACAO 
 WHERE CD_IMPLANTACAO = 2 AND NR_MATRICULA = 12358; 
 
 
-- DESCARTANDO A DELEÇÃO NÃO EFETIVADA
ROLLBACK; 
      
DELETE FROM T_SIP_FUNCIONARIO
WHERE NR_MATRICULA = 0;
